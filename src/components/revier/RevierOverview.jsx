  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#1e1e1e] rounded-2xl border border-[#2a2a2a] p-6">
        <h2 className="text-lg font-semibold text-gray-100 mb-4">Revier-Information</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div>
            <span className="text-gray-500">Region</span>
            <p className="font-medium text-gray-200 mt-1 flex items-center gap-1">
          ...
          <div className="col-span-2">
            ...
            <p className="font-medium text-gray-200 mt-1">{revier.notes || "—"}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {stats.map(({ label, value, icon: Icon, color }) => (
          <div key={label} className="bg-[#1e1e1e] rounded-2xl border border-[#2a2a2a] p-5">
